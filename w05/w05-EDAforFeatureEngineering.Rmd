---
title: 'A Case Study in EDA and Feature Engineering'
author: "Cheng Peng"
...
We have introduced the techniques and tools for exploratory data analysis and some commonly used methods for feature engineering. This note provides an example to show how to use these methods to extract powerful features and improve subsequent modeling.
...
We have introduced several techniques and methods in an earlier note. We will primarily focus on using some EDA techniques and methods as needed for this data and subsequent modeling.  We first scan the entire data set and determine the EDA tools to use for feature engineering.
...
In data science projects, many problems are related to prediction. Unlike the classical statistical inference problems which require strict (distributional) assumptions and model interpretability, predictive modeling problems focus on the predictive performance but not interpretability. Transformations such as scaling, standardization, and other transformations that improve performance are routine procedures. Model-based feature extraction methods are also used if they improve the model performance. These feature engineering methods will be discussed in detail in the subsequent notes.
