...
\vspace{2mm}
\begin{figure}
  \includegraphics[width=40mm,scale=0.5]{\string image/PoorDesign.png}
\end{figure}
\vspace{2mm}
...
\vspace{2mm}
\begin{figure}
  \includegraphics[width=40mm,scale=0.5]{\string image/DistortedAxes.png}
\end{figure}
\vspace{2mm}
...
\vspace{2mm}
\begin{figure}
  \includegraphics[width=70mm,scale=0.5]{\string image/ViolentCrimeRate.png}
\end{figure}
\vspace{2mm}
...
\vspace{2mm}
\begin{figure}
  \includegraphics[width=100mm,scale=0.5]{\string image/LifeExpectancy02.png}
\end{figure}
\vspace{2mm}
...
\vspace{5mm}
\begin{figure}
  \includegraphics[width=100mm,scale=0.5]{\string image/SpuriousCorrelation.png}
\end{figure}
\vspace{2mm}
\vspace{3mm}
...
\vspace{5mm}
\begin{figure}
  \includegraphics[width=70mm,scale=0.5]{\string image/PresdiElection.png}
\end{figure}
\vspace{2mm}
\vspace{3mm}
...
\vspace{5mm}
\begin{figure}
  \includegraphics[width=90mm,scale=0.5]{\string image/WrongInterpretation.png}
\end{figure}
\vspace{2mm}
\vspace{3mm}
...
\vspace{5mm}
\begin{figure}
  \includegraphics[width=70mm,scale=0.5]{\string image/LifeExpectancy.png}
\end{figure}
\vspace{2mm}
...
\vspace{2mm}
\begin{figure}
  \includegraphics[width=80mm,scale=0.5]{\string image/LifeCigarette.png}
\end{figure}
\vspace{2mm}
...
\vspace{5mm}
\begin{figure}
  \includegraphics[width=70mm,scale=0.5]{\string image/Uncertainty.png}
\end{figure}
\vspace{2mm}
...
\vspace{5mm}
\begin{figure}
  \includegraphics[width=100mm,scale=0.5]{\string image/AdjustedDatViz.png}
\end{figure}
\vspace{2mm}
...
\vspace{3mm}
\begin{figure}
  \includegraphics[width=70mm,scale=0.5]{\string image/ConcellingConfusing.png}
\end{figure}
\vspace{2mm}
...
\vspace{3mm}
\begin{figure}
  \includegraphics[width=60mm,scale=0.5]{\string image/SuggestingMisleadingInfo.png}
\end{figure}
\vspace{2mm}
...
\vspace{3mm}
\begin{figure}
  \includegraphics[width=60mm,scale=0.5]{\string image/InsufficicentInfo.png}
\end{figure}
\vspace{2mm}
