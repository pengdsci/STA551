---
title: "An Overview of Commonly Used Suoervised ML Algorithms"
author: "Cheng Peng"
...
plot(1-giniROC11$senspe.mtx[2,], giniROC11$senspe.mtx[1,], type = "l", 
...
legend("bottomright", c(paste("gini.1.1,  AUC =", giniROC11$AUC), 
                        ...
                        lty=rep(1,6), lwd=rep(2,6), cex = 0.8, bty = "n")
```
