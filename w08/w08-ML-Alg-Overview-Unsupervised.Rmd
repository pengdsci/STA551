...
```{r echo=FALSE, fig.align='center', fig.width=3, fig.height=3, fig.cap="Figure 2. illustration of cluster analysis."}
...
## Select A Pre-determined Number of Classes
...
```{r echo=FALSE, fig.align='center', fig.width=3, fig.height=3, fig.cap="Figure 3. (a) A visual curve with an explicit elbow point. (b) A visual curve being fairly smooth with an ambiguous elbow point."}
...
```{r echo=FALSE, fig.align='center', fig.width=3, fig.height=3, fig.cap="Figure 4. Updating centroids in the process of finding the final centroids"}
...
```{r, fig.cap="Figure 5: Heatmap representation of potential clusters"}
...
```{r, fig.cap="Figure 7: Elbow plot for optimal number of clusters."}
wss = NULL
K = 15
for (i in 1:K){
...
```{r, fig.cap= "Figure 8. Final cluster results: visual inspection"}
...
```{r echo=FALSE, fig.align='center', fig.width=3, fig.height=3, fig.cap="Figure 9. Illustration of types of hierarchical clustering."}
...
```{r echo=FALSE, fig.align='center', fig.width=3, fig.height=3, fig.cap="Figure 10. Illustration of steps of agglomerative hierarchical clustering."}
...
```{r, fig.align = 'center', fig.cap= "Figure 11. Dendrogram: hierarchical clustering"}
...
```{r, fig.align="center", fig.cap="Figure 12. Dendrogram: hierarchical clustering: No X-Labels"}
...
```{r, fig.align='center',fig.cap= "Figure 13. Elbow plot: Optimal number of clusters"}
fviz_nbclust(scales.hierarch, FUN = hcut, method = "wss")
```

```{r,fig.align='center',fig.cap= "Figure 14. Silhouette plot: Optimal number of clusters"}
...
```{r, fig.align='center',fig.cap= "Figure 15. Visual check the resulting clusters obtained from agglomerative hierarchical clustering."}
...
## Case Study II: Multi-feature Clustering

The Iris Dataset contains four features (length and width of sepals and petals) of 50 samples of three species of Iris (Iris setosa, Iris virginica, and Iris versicolor). These measures were used to create a linear discriminant model to classify the species. The dataset is often used in data mining, classification, and clustering examples and to test algorithms.

```{r echo=FALSE, fig.cap="Figure 16. Iris data set: variables illustration - pedal and sepal", out.width="60%",  fig.align = "center"}
...
```{r echo=FALSE, fig.align='center', out.width="70%", fig.cap="Figure 17. Illustration PCA."}
if (knitr:::is_latex_output()) {
...
```{r echo=FALSE, fig.cap="Figure 18. Graphical interpretation of PCA with two correlated variables", out.width="60%",  fig.align = "center"}
...
```{r, fig.align= 'center', fig.cap="Figure 18. Scree plot of PCA on Iris Data"}
screeplot(ir.pca, 
          type = "lines",
...
```{r echo=FALSE, fig.cap="Figure 19. Screenshot of the final iris data set with new variables defined based on the principal components", fig.width=2, fig.length=4,  fig.align = "center"}
